...
contenido = os.listdir('../dataset/Gowalla/user_ratings/')

# recorremos cada fichero
for name in contenido:
    fichero = '../dataset/Gowalla/user_ratings/' + name 
    ...
    ftrain = 'train_test/Gowalla/' + ciudad + '/train.txt'
    ftest = 'train_test/Gowalla/' + ciudad + '/test.txt'
